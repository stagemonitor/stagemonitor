...
public class RateLimitingPreExecutionInterceptorTest {
	...
	public void testAlwaysReportServerSpan() throws Exception {
		...
		when(requestMonitorPlugin.getOnlyReportNRequestsPerMinuteToElasticsearch()).thenReturn(1_000_000.0);
	...
	public void testRateNotExceededServerSpan() throws Exception {
		...
		when(requestMonitorPlugin.getOnlyReportNRequestsPerMinuteToElasticsearch()).thenReturn(10.0);
