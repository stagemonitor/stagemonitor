...
public class AroundProfilerTest {
	...
	public int method1() {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method1()");
		}
	}
	...
	private int method2(int i) {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method2(int i)");
		}
	}
	...
	private int method3() {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method3()");
		}
	}
	...
	private int method4() {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method4()");
		}
	}
	...
	private int method5() {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method5()");
		}
	}
	...
	private int method6() {
		...
		try {
			...
			AroundProfiler.stop(cse, "public int de.isys.jawap.benchmark.profiler.ClassToProfile.method6()");
		}
	}
