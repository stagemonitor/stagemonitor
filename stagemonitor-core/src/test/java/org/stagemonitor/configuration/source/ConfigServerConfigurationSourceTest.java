...
public class ConfigServerConfigurationSourceTest {
	...
	public void whenReturnCodeNot200_thenEmptyConfiguration() {
		...
		final SpringCloudConfigConfigurationSource dut = new SpringCloudConfigConfigurationSource(http, "http://localhost/config", "myservice", "prod");
	...
	public void whenBadConfigServerAddress_thenThrowException() {
		...
		prepMockWithResponse(http, null, 200, null);
		final SpringCloudConfigConfigurationSource dut = new SpringCloudConfigConfigurationSource(http, "malformedAddress", "myservice", "prod");
	}
	...
	public void whenMissingConfigServerAddress_thenThrowException() {
		...
		prepMockWithResponse(http, null, 200, null);
		final SpringCloudConfigConfigurationSource dut = new SpringCloudConfigConfigurationSource(http, "", "myservice", "prod");
	}
	...
	public void whenMissingServiceName_thenThrowException() {
		...
		prepMockWithResponse(http, null, 200, null);
		final SpringCloudConfigConfigurationSource dut = new SpringCloudConfigConfigurationSource(http, "http://some.domain", "", "prod");
	}
