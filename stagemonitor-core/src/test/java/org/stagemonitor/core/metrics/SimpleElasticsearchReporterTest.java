...
public class SimpleElasticsearchReporterTest extends AbstractElasticsearchTest {
	...
	public void testReport() throws Exception {
		...
		assertEquals(String.format("{\"applicationName\":null," +
				...
				"\"startTimestamp\":\"%s\"," +
				"\"endTimestamp\":null," +
				"\"startTimestampEpoch\":%s," +
				"\"endTimestampEpoch\":null," +
				...
				Stagemonitor.getMeasurementSession().getStartTimestamp(), Stagemonitor.getMeasurementSession().getStartTimestampEpoch()),
