...
[![Build Status](https://travis-ci.org/stagemonitor/stagemonitor.svg?branch=master)](https://travis-ci.org/stagemonitor/stagemonitor) [![Coverage Status](https://coveralls.io/repos/stagemonitor/stagemonitor/badge.svg?branch=master&service=github)](https://coveralls.io/github/stagemonitor/stagemonitor?branch=master) [![Maven Central](https://maven-badges.herokuapp.com/maven-central/org.stagemonitor/stagemonitor-core/badge.svg)](https://maven-badges.herokuapp.com/maven-central/org.stagemonitor/stagemonitor-core)  [![Release](https://jitpack.io/v/stagemonitor/stagemonitor.svg)](https://jitpack.io/#stagemonitor/stagemonitor)
=================
...
## Snapshots
Use [JitPack](https://jitpack.io/#stagemonitor/stagemonitor/master-SNAPSHOT) to get the latest snapshots from master.
