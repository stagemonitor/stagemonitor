...
public class MonitoredHttpExecutionForwardingTest {
	...
	public void testForwarding() throws Exception {
		...
		assertNull(getMetric2Registry().getTimers().get(name("response_time").tag("request_name", "GET /monitored1").tag("tier", "server").tag("layer", "total").build()));
		assertNull(getMetric2Registry().getTimers().get(name("response_time").tag("request_name", "GET /monitored2").tag("tier", "server").tag("layer", "total").build()));
		assertNotNull(getMetric2Registry().getTimers().get(name("response_time").tag("request_name", "GET /monitored3").tag("tier", "server").tag("layer", "total").build()));
	}
