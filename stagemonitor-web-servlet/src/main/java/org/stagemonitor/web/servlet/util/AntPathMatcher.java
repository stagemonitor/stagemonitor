...
/**
 * {@code PathMatcher} implementation for Ant-style path patterns.
 *
...
public class AntPathMatcher {
	...
	private static class StringUtils {
		...
		/**
		 * Tokenize the given {@code String} into a {@code String} array via a {@link StringTokenizer}. <p>The given {@code
		 * delimiters} string can consist of any number of delimiter characters. Each of those characters can be used to
		 * separate tokens. A delimiter is always a single character; for multi-character delimiters, consider using {@code
		...
		/**
		 * Copy the given {@code Collection} into a {@code String} array. <p>The {@code Collection} must contain {@code
