...
return b}function R(a,b){if(S&&e.JSON){var d;d=m.getEntriesByType('resource');for(var g=new D,q=0,f=d.length;q<f;q++){var h=d[q];if(!(null!=b&&h.startTime-c.C+c.b<b)){var k=h.name,x=k.toLowerCase();'about:blank'!==x&&0!==x.indexOf('javascript:')&&(255<k.length&&(k=k.substring(0,255)),('xmlhttprequest'!==h.initiatorType||h.startTime<c.C)&&g.R(k,ca(h)))}}d=g.N();a.res=e.JSON.stringify(d);c.G&&m.clearResourceTimings&&m.clearResourceTimings()}}function ca(a){var b=[Math.round(a.startTime-c.C),Math.round(a.duration),
...
(a.d=Number(v.time)-c.j,a.tim='0');a.t_unl=b.unloadEventEnd-b.unloadEventStart;a.t_red=d;a.t_apc=b.domainLookupStart-b.fetchStart;a.t_dns=b.domainLookupEnd-b.domainLookupStart;null!=b.secureConnectionStart&&0<b.secureConnectionStart?(a.t_tcp=b.secureConnectionStart-b.connectStart,a.t_ssl=b.connectEnd-b.secureConnectionStart):(a.t_tcp=b.connectEnd-b.connectStart,a.t_ssl=0);a.t_req=b.responseStart-b.requestStart;a.t_rsp=b.responseEnd-b.responseStart;a.t_pro=b.loadEventStart-b.domLoading;a.t_loa=b.loadEventEnd-
b.loadEventStart;if(S){for(var b=m.getEntriesByType('paint'),d=!1,l=0;l<b.length;l++){var f=b[l];switch(f.name){case 'first-paint':a.t_fp=f.startTime|0;d=!0;break;case 'first-contentful-paint':a.t_fcp=f.startTime|0}}d||V(a,g)}else V(a,g)}else a.ts=M()-c.b,a.d=Number(v.time)-c.j,N||(a.tim='0');R(a);z(a)}},h:function(){return null},B:function(){},A:function(){n('spaTransition')},i:function(){}});I('spaTransition',{v:function(){g.k=c.f;g.r=c.b;g.t=C();g.ts=u();g.ty='spa';g.pl=c.g},h:function(){return g.t},
B:function(){},A:function(){n('spaTransition')},i:function(a){g.p=c.page;g.l=a.url;g.e=a.explanation;g.d=u()-g.ts;switch(a.status){case 'completed':g.s='c';break;case 'aborted':g.s='a';break;case 'error':g.s='e';break;default:g.s='u'}A(g);R(g,g.ts-1);z(g);n('pageLoaded')}});n('init')})();})();
