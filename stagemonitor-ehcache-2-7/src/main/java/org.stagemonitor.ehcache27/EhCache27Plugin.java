package org.stagemonitor.ehcache27;
...
public class EhCache27Plugin extends StagemonitorPlugin {
	 ...
	 */
	public void monitorCache(final Ehcache cache) {
		metricRegistry.registerAny(new Metric2Set() {
			@Override
			public Map<MetricName, Metric> getMetrics() {
				Map<MetricName, Metric> metrics = new
				cache.getStatistics().cacheEvictedCount();
